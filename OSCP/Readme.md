## TRY HACK ME ROOMS TO OSCP
```
1)	Jr PenTester https://tryhackme.com/path-action/jrpenetrationtester/join
2)	Offensive PenTesting https://tryhackme.com/path-action/pentesting/join
3)	Web Fundamentals https://tryhackme.com/path-action/web/join
4)	Windows Fundamentals https://tryhackme.com/module/windows-fundamentals
5)	Windows Exploitation https://tryhackme.com/module/hacking-windows-1
6)	Shell and Privilege Escalation https://tryhackme.com/module/privilege-escalation-and-shells
7)	Host Evasion https://tryhackme.com/module/host-evasions
8)	Enumerating AD https://tryhackme.com/room/adenumeration
9)	Breaching Active Directory https://tryhackme.com/room/breachingad
10)	Exploitation AD https://tryhackme.com/room/exploitingad
11)	Lateral Movement and Pivoting https://tryhackme.com/room/lateralmovementandpivoting
12)	Persistence AD https://tryhackme.com/room/persistingad
13)	Post Compromisse 
 a)	 https://tryhackme.com/module/post-compromise
 b)	 https://www.linkedin.com/in/joas-antonio-dos-santos/
```

## HACK THE BOX LABS TO OSCP
```
1)	Forest
2)	Active
3)	Reel
